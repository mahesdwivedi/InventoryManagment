...
<a id="btnEmpty" href="dispatch.php?action=empty">Empty Cart</a>
<?php
...
<?php
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="dispatch.php?action=remove&sku=<?php echo $item["sku"]; ?>"
...
<div id="product-grid">
	<div class="txt-heading">Products</div>
			...
			<form method="post" action="dispatch.php?action=add">
